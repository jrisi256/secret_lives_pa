...
data <-
    ...
    filter(mult_defense != 1 & mult_prosecutor != 1)
...
saveRDS(full_model_max, file.path(write_dir, "no_mult_actor_full_model_max.rds"))
saveRDS(full_model_min, file.path(write_dir, "no_mult_actor_full_model_min.rds"))
